...
latex_documents = [
    (master_doc, 'ebisim.tex', 'ebisim Documentation',
     'Hannes Pahl', 'manual'),
]
...
man_pages = [
    (master_doc, 'ebisim', 'ebisim Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ebisim', 'ebisim Documentation',
     author, 'ebisim', 'One line description of project.',
     'Miscellaneous'),
]
