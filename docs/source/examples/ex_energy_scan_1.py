...
sim_kwargs= dict(
    ...
    j=2000, # current density in A/cm^2
...
scan.plot_abundance_at_time(t=2, cs=[17,18])

# Alternativley one can create a plot to see how a given charge states depends on the breeding time
